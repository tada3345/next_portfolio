    ...
    >
      ...
      <div className="space-y-10 px-0 md:px-10">
        ...
        <ul className="text-base list-disc">
          ...
          <li className="mb-2">
            多数の特設ページを制作した経験があるので、リスポンシブで管理のしやすいHPの制作が可能。
          </li>
          <li className="mb-2">
            SNS担当の経験があり、自ら作曲した楽曲とアニメーションで計48,708回の閲覧数をたたき出した経験があり、注目される要素を追加することが可能。
          </li>
          <li className="mb-2">
            データベースを用いて予約サイトとその管理ページを開発と管理をした経験があり、バックエンドとのスムーズなやり取りが可能。
          </li>
        </ul>
      </div>
    </motion.div>
